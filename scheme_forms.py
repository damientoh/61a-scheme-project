...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # BEGIN PROBLEM 4
        # print('DEBUG: body: ', expressions.rest)
        # body = expressions.rest.map(lambda y: scheme_eval(y, env))
        # env.define(expressions.first, body.first)
...
def make_let_frame(bindings, env):
    ...
    while bindings is not nil:
        ...
        validate_form(bindings.first.rest, 0, 1)
        validate_form(bindings.first.rest, 1)
